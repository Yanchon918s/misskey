...
export type IUpdateStatusRequest = operations['i___update-status']['requestBody']['content']['application/json'];
export type IUpdateStatusResponse = operations['i___update-status']['responses']['200']['content']['application/json'];
...
export type NiwaShowResponse = operations['niwa___show']['responses']['200']['content']['application/json'];
export type NiwaWaterResponse = operations['niwa___water']['responses']['200']['content']['application/json'];
